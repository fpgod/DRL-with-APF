...
class Simulator:
    ...
    def step(self,new_velocity,new_position):
        """
        ...
        for agentNo in range(self.num_agents):
            self.agents_[agentNo].update(Vector2(new_velocity[agentNo][0]*100,new_velocity[agentNo][1]*100),Vector2(new_position[agentNo][0]*100,new_position[agentNo][1]*100))
